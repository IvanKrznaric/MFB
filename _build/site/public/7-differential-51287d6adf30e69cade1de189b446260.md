...
Because [the differential approimates the exact change](#differential), we know that
\begin{equation*}
...
Because [the differential approimates the exact change](#differential), we know that $dP(2) \approx P'(2) \cdot dI.$ Therefore, we have the following approximation
\begin{equation*}
