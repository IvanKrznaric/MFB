...
We will be refering to the elasticities $E_{q_1, p_1}$ and $E_{q_2, p_1}$ as **<span style = "color:green">cross-price elasticities,</span>** as they tell us what happens to the demand of one goods if the price of another good increases.
