# 1. <span class = "break"></span> Matrices and matrix operations

## <span class = "h2-num">1.1 </span><span class = "h2-text"> Introduction </span>
...
\begin{array}{| c | c | c | c |}
\hline
\hspace{0.1cm} & \text{Agriculture} &\text{Manufacturing} &\text{Energy} \\
\hline
...
## <span class = "h2-num">1.2</span><span class = "h2-text"> Types of matrices </span>
...
## <span class = "h2-num">1.3</span><span class = "h2-text"> Matrix operations </span>
:::{tip}
:class:dropdown
...
:::{tip} <span style = "color : #228B22"> Definition </span>
:icon:false
If $A = [a_{ij}]$ and $B = [b_{ij}]$ are matrices of the same order $n \times m,$ then their **<span style = "color:green"> sum </span>** is the matrix $C = [c_{ij}]$ of order $n \times m$ where
...
:::{tip} <span style = "color : #228B22"> Definition </span>
:icon:false
Let $A = [a_{ij}]$ be a matrix of order $n \times m$ and let $\alpha \in \R$ be a scalar (i.e. a number). **<span style = "color:green"> Multiplication of the matrix $A$ by a scalar </span>** $\alpha$ is a matrix $B = [b_{ij}],$ where 
...
:::{tip} <span style = "color : #228B22"> Definition </span>
:icon:false
**<span style = "color:green"> Scalar product </span>** of a row-matrix $\begin{bmatrix} a_1 & a_2 & \dots & a_n\end{bmatrix}$ and a column-matrix $\begin{bmatrix} b_1 \\ b_2 \\ \vdots \\ b_n\end{bmatrix}$ is defined as 
...
:::{tip} <span style = "color : #228B22"> Definition </span>
:icon:false
Let $A = [a_{ij}]$ be a matrix of order $n \times m$ and $B = [b_{ij}]$ be a matrix of order $m \times p.$ We define **<span style = "color:green"> matrix multiplication </span>** of matrices $A$ and $B$ as a matrix $C = [c_{ij}]$ of order $n \times p,$ whose elements are given by
