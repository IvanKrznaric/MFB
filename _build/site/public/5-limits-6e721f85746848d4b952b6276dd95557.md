...
\end{equation*}
If the interest is being paid-out in very small time intervals - meaning quite a lot of times during a year - then $x$ is a very very big number and we can find the value of the initial deposit will have at the end of the year by using the formula stated above:
\begin{equation*}
