...
\end{equation*}
where $r_0 = 3$ is the initial interest rate. In our case, we know that $dr = 0.75,$ and we want to compute $\Delta P(r_0) = \Delta P(3).$ Hence, the only thing we are missing is the value of the derivative $P'(3).$
````
