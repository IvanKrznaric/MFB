...
The answers to all of these questions are going to be algorithmic in nature, meaning we will state the algorithm which will lead us to answers to the questions above. The main thing that we'll use to derive those algorithms is the connection between the function $f$ and its derivatives.
