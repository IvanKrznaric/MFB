...
:icon:false
**<span style = "color:green"> A matrix </span>** is a rectangular array of numbers. If a matrix has $n$ rows and $m$ columns, we say that the **order** of that matrix is $n \times m.$
:::
