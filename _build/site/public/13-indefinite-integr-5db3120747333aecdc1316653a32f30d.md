...
The central problem of this part of the course is the following: how to calculate the area under the graph of a function? In order to give a full answer to this question, we need to understand the following two questions:
