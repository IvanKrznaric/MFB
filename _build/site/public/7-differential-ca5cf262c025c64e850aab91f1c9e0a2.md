...
- **<span style = "color:green"> absolute error </span>** $\dots \lvert \Delta f(x_0) - df(x_0)\rvert$
- **<span style = "color:green"> relative error </span>** $\dots \frac{\lvert \Delta f(x_0) - df(x_0)\rvert}{\Delta f(x_0)}$