...
The difference between these two forms is that in explicit form we know the formula by which $y$ is given, while in implicit form we don't immediately know that formula (although we can easily compute it).
