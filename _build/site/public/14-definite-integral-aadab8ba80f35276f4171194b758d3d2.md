...
In this section we are going to use the definite integral to compute the area. Namely, the area under the graph of the function $f(x)$ over the interval $[a,b]$ is equal to the value of the definite integral $\displaystyle \int_a^b f(x) \, dx$.
