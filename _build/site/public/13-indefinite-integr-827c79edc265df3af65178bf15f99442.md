...
\end{equation*}
So, in order to compute the integral in this question we simply need to compute the two integrals above. The second one is straight-forward, since we can use the formula given in the [table of integrals](#table-intergal):
\begin{equation*}
\int 3x^2 \, dx = x^3.
\end{equation*}
````
