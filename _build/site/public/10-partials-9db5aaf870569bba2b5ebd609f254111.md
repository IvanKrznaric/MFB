...
\end{equation*}
exists, then we say that the value of that limit is the **<span style = "color: green"> partial derivative </span>** of the function $f$ with respect to the variable $y$ and that limit is denoted by $f_y.$ \n
