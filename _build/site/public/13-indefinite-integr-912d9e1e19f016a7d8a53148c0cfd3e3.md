...
As it was with the derivative, not all integrals we would like to know how to compute can be calculated using just the most basic [formulas for integral](#table-integrals), so we need a new method that will allow us to find integrals of more complicated functions.
