...
\begin{equation*}
\begin{split}
\lvert P(2+dI) - P(2) \rvert &\leq \frac{1}{100} \cdot P(2) \\
\iff \lvert (14+5dI)^{\sqrt{9+dI}} - 2744 \rvert &\leq 27.44
\end{split}
\end{equation*}
...
\iff \lvert P'(2) \cdot dI \rvert &\leq 27.44
\end{split}
\end{equation*}
...
\begin{equation*}
\begin{split}
\lvert P'(2) \cdot dI \rvert &\leq 27.44 \\
\implies \lvert dI \rvert &\leq \frac{27.44}{P'(2)} = 
\end{split}
\end{equation*}
````