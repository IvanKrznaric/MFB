...
:::{note} Problem 6.5
:icon: false
Find the derivative of the function $\displaystyle f(x) = \frac{2^x}{x^2+5} \cdot \sqrt{x}.$
:::

## 6.3 Derivative of composition of functions
The following formula tells us how to find derivative of compositions: $$f(g(x))' = f'(g(x)) \cdot g'(x).$$
