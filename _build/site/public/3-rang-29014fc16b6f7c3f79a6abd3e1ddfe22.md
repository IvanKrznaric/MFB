...
:::{error} Common mistake on the Midterms/Exam
:class:dropdown
...
A lot of students confuse these two notions when they are questioned on on the Midterms or the Exam, so keep in mind what is the definition and what is the consequence of the definition.
:::
