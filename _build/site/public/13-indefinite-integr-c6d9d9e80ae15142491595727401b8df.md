...
:::{caution} 💡 
:icon:false
In the same way as with subsitution method, we can use integration by parts to reduce the task of computing something rather complicated to computing something straight-forward.
:::