...
How to use the rectangles to approximate the area under the graph of a function. In each iteration we are using rectangles of smaller and smaller width until they perfectly add up to the area we want to compute.
:::
