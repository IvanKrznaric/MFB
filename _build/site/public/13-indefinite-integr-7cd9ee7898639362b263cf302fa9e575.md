...
:::{caution} 💡 
:icon:false
Notice the main point about substitution method: we get rid of the complicated part by using the substitution, leaving us with a straight-forward computation.
:::
