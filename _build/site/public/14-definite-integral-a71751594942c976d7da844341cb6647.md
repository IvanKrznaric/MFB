...
In this section we are going to learn how to find definite integral of a given function $f(x)$, which will be denoted as $\displaystyle \int _a ^b f(x) \, dx$. and in doing so we are going to be using the following formula.
