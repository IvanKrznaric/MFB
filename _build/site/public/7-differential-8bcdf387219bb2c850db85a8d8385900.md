...
R(A) = 500\ln(A) + 10 000.
\end{equation*}
Currently, the business is spending $14 \hspace{0.1 cm} 600$ euros on advertising and their goal is to increase their revenue by approximately $3\%.$ Use the differential to approximate the additional amount of money they need to be spending on advertising in order to achieve their goal.
:::
