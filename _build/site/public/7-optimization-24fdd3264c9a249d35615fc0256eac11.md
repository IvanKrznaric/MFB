...
:::{note} Problem 7.1
:icon: false
Let $f(x) = e^x - x.$ Find the local extreme points and the corresponding extreme values.
:::

:::{note} Problem 7.2
:icon: false
Let $f(x) = \frac{x}{1+x^2}.$ Find the local extreme points and the corresponding extreme values.
:::
