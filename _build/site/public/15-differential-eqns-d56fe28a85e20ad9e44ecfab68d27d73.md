...
Now, our goal is to come up with an algorithm that we'll be able to use for solving differential equations. As mentioned before, we will use the algorithm for solving linear equations and try to adapt its steps. 
