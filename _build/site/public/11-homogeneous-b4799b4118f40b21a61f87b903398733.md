...
:::{note} Problem 11.11
:icon: false
Companies $A$ and $B$ provide the service of making financial models for various industries. Company $A$ charges $p_1$ for its services, while the company $B$ charges $p_2.$
:::
