...
Imagine that you deposited $p$ euros into a bank and let's suppose that the bank will offer you an annual interest rate of $r \%.$ FWe are interested in the amount of money will we have after the interest has been paid out. 
...
\end{split}
\end{equation*}
Generalizing, if the interest is paid out $n$ times a year, then  at the end of the year we will have
\begin{equation*}
a = p(1+\frac{r}{n})^n.
\end{equation*}
:::
