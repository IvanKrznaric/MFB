...
\end{equation*}
So, in order to compute the integral in this question we simply need to compute the two integrals above. The second integral is easy, since we can use the formula given in the [formulas for integration](#table-integrals):
\begin{equation*}
\int 3x^2 \, dx = x^3.
\end{equation*}
````
