...
- If the company $B$ charges $p_2 = 5$ units for its services, determine all the prices for which the company $A$ can charge its services so that these services are complements.
:::
