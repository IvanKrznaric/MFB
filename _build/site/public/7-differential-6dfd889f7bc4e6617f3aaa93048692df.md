...
\end{equation*}
where $A_0 = 14600$ is the initial amount of money being invested in advertising. If the business wants to increase their revenue by $3\%,$ then $\Delta R(A_0) = 0.05R(A_0).$
````
